...
const handleSignUp = async (name, email, password, phone_number, toast, navigate, checkEmailFormat, checkPhoneFormat, setIsLoading, setEmailError, setPhoneError, setError) => {
  setIsLoading(true);
  try {
    ...
    if (response.status === 200) {
      ...
      setPhoneError("Phone Number should be a 10 digit number (e.g., +919876543210)");
