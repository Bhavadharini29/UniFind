      ...
      <div className="md:flex items-center justify-between bg-navy py-1 md:px-10 shadow-lg bg-blue-900">
        <div className="flex items-center gap-3 lg:ml-16 md:ml-8 ml-5">
          <div
            ...
            onClick={() => navigate("/")}
          >
            <h1 className="text-2xl lg:text-3xl font-bold">UniFind- Lost and Found Companion</h1>
        ...
        <ul
          className={`md:flex md:items-center md:justify-center md:pb-0 pb-12 absolute md:static bg-navy w-full md:w-auto md:pl-0 pl-9 transition-all ease-in-out duration-500 ${menu
