...
const content = {
  ...
  statistics: [
    {
      number: "",
      description: "Post Lost Items"
    },
    {
      number: "",
      description: "Track items recovered"
    },
    {
      number: "",
  ...
  communityHelpData: {
    ...
    semititle: "lost item.",
    icon: "/school.svg",
    subtitle: "Help people recover lost items.",
